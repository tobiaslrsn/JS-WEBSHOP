...
})({"g3uL0":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "6e84649a3d8029fb";
"use strict";
...
},{}],"jsGMI":[function(require,module,exports) {
...
function productsToPage() {
    ...
    for(let i = 0; i < _productObject.products.length; i++){
        ...
        productImage.addEventListener("click", ()=>{
            window.localStorage.setItem("product", JSON.stringify(_productObject.products[i]));
            location.href = photoRedirect.href;
        });
        let productArtist = document.createElement("p");
        productArtist.className = "artist";
        productArtist.innerHTML = _productObject.products[i].artist;
        let productAlbum = document.createElement("p");
        productAlbum.className = "album";
        productAlbum.innerHTML = _productObject.products[i].album;
        let productYear = document.createElement("p");
        productYear.className = "year";
        productYear.innerHTML = "year: " + _productObject.products[i].year;
        let productPrice = document.createElement("p");
        productPrice.className = "price";
        productPrice.innerHTML = "price: " + _productObject.products[i].price + " SEK";
        let productGenre = document.createElement("p");
        productGenre.className = "genre";
        productGenre.innerHTML = "Genre: " + _productObject.products[i].genre;
        //PURCHASE BUTTON
        let addToCart = document.createElement("button");
        addToCart.className = "purchase-button";
        addToCart.innerHTML = _productObject.products[i].addToCart;
        addToCart.addEventListener("click", ()=>{
            cart.addToCart(_productObject.products[i]);
            cart.offcanvasCart();
            document.getElementById("cartCount").innerHTML = "" + cart.getCart.length;
        });
        ...
        infoBtn.innerHTML = _productObject.products[i].infoBtn;
        ...
        listenBtn.innerHTML = _productObject.products[i].listenBtn;
        //CREATE SPOTIFYLOGO
        ...
        spotifyUrl.href = _productObject.products[i].spotifyUrl;
...
},{"./models/shoppingcart":"gfr0H","./product-object":"49Kyn","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"49Kyn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "products", ()=>products
);
var _articleClass = require("./models/Article-class");
...
},{"./models/Article-class":"gOZV8","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"gOZV8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["g3uL0","jsGMI"], "jsGMI", "parcelRequire1848")

//# sourceMappingURL=index.3d8029fb.js.map
